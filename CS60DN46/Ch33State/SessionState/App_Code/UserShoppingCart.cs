...
public class UserShoppingCart {
	...
	public override string ToString() => $"Car: {DesiredCar}<br>Color: {DesiredCarColor}<br> Down: { DownPayment}" + $"<br>Lease: {IsLeasing}<br>Pick-up Date: {DateOfPickUp.ToShortDateString()}";
}
